...
"""
                    ...
                    print(f"❌ Plan parsing failed after {max_retries + 1} attempts: {e}")
...
"""
        ...
        try:
            ...
            fallback_observation = {
                ...
                "direct_answers": [],
                "summary": raw_observation[:200] + "..." if len(raw_observation) > 200 else raw_observation,
...
"""
    ...
    def observe_and_think(
        ...
        """
        print(f"🧠 Predictive Planner: Analyzing observation and generating thoughts...")
...
"""
    ...
    def evaluate_and_correct(
        ...
        """
        print(f"⚖️ Predictive Planner: Evaluating results and determining correction strategy...")
...
"""
    ...
    def think_and_evaluate(
        ...
        """
        print(f"� Predictive Planner: Running PPoGA sequence (Observe → Think → Evaluate)...")
        ...
        think_result = self.think(prediction, structured_observation, plan_step, memory_context)
        thinking_analysis = think_result.get("thinking_analysis", {})

        # Step 3: Evaluate - Decide next action
        evaluate_result = self.evaluate(thinking_analysis, structured_observation, plan_step, memory_context)
